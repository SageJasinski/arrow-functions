...
//this I think is referring to the new Student object created in line 167 as when you console log it it console logs the new object

// 2. What is "this" when joe.scopeArrow() is invoked?
//I see it is referencing the window as in the browser window while also printing the empty sting for name and a generic "Location"

// 3. Explain why "this" is different when an arrow function is used.
//I think it is different because it references the upper most function that the arrow function is wrapped in, iof there isn't anything wrapping it then it will reference the browser window which is the parent of the function.